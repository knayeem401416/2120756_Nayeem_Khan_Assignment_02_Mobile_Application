...
import 'package:chat_application/services/user_management_services.dart';
import 'package:chat_application/services/utils/helper_functions.dart';
import 'package:chat_application/services/utils/validators.dart';
import 'package:chat_application/widgets/custom_buttons/Rouded_Action_Button.dart';
import 'package:chat_application/widgets/input_widgets/password_input_field.dart';
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextDesign()
                                .bodyTextSmall
                                .copyWith(color: MyColor.disabled),
                          ),
                          InkWell(
                              onTap: () {
                              ...
                              child: Padding(
                                ...
                                child: Text("Login Now!",
                                    style: TextDesign().pageTitle.copyWith(
                                        color: MyColor.primary, fontSize: 13)),
                              ))
                        ],
                      ),
                    ],
